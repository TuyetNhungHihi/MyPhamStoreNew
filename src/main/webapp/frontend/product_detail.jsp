        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="ss_inner_title_cont_wrapper">
            <ul>
              ...
              <li>Sẩn phẩm&nbsp;&nbsp; ></li>
              <li>Kem dưỡng ẩm&nbsp;&nbsp; ></li>
              <li>Kem Dưỡng Ẩm Skin1004 Làm Dịu Da Chiết Xuất Rau Má Madagascar Centella Soothing Cream 75Ml</li>
            </ul>
          </div>
        </div>
      </div>
            ...
            <div class="video_nav_img hidden-xs">
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <a class="button secondary url owl_nav" href="#zero">
                  <img
                    src="https://www.guardian.com.vn/media/catalog/product/cache/30b2b44eba57cd45fd3ef9287600968e/5/4/5448_fe6c2000ad24415395320feac1a6d2d0_358f8379974d40feb7e1a3ea2e82d64f_8813699f8dc3498cb29ae3fa3322876a_vgikiapjsdofsah3.jpg"
                    class="img-responsive" alt="nav_img" />
                </a>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                <a class="button secondary url owl_nav" href="#one">
                  <img
                    src="https://www.guardian.com.vn/media/catalog/product/cache/30b2b44eba57cd45fd3ef9287600968e/3/0/3023960_gqyugemvie8iz6za.png"
                    class="img-responsive" alt="nav_img" />
                </a>
              </div>
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                <a class="button secondary url owl_nav" href="#two">
                  <img
                    src="https://www.guardian.com.vn/media/catalog/product/cache/30b2b44eba57cd45fd3ef9287600968e/5/4/5448_fe6c2000ad24415395320feac1a6d2d0_358f8379974d40feb7e1a3ea2e82d64f_8813699f8dc3498cb29ae3fa3322876a_vgikiapjsdofsah3.jpg"
                    class="img-responsive" alt="nav_img" />
                </a>
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 cc_ps_tabs">
                <a class="button secondary url owl_nav" href="#three">
                  <img
                    src="https://www.guardian.com.vn/media/catalog/product/cache/30b2b44eba57cd45fd3ef9287600968e/3/0/3023960_gqyugemvie8iz6za.png"
                    class="img-responsive" alt="nav_img" />
                </a>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="cc_ps_cart_btn_wrapper">
                    <div class="cc_ps_cart_btn">
                      <ul>
                        <li>
                          <a id="add-to-cart" href="#"><i class="fa fa-shopping-cart"></i>Thêm Vào Giỏ</a>
                        </li>
                        <li>
                          <a href="/src/main/webapp/frontend/shopping_cart.html"><i class="fa fa-bolt"></i> Mua Ngay</a>
                        </li>
                        <li>
          ...
          <div class="btc_shop_single_prod_right_section">
            <div class="btc_shop_sin_pro_icon_wrapper">
              ...
              <div class="ss_featured_products_box_img_list_cont ss_featured_products_box_img_list_cont_single">
                <h4><a href="#">Kem Dưỡng Ẩm Skin1004 Làm Dịu Da Chiết Xuất Rau Má Madagascar Centella Soothing Cream
                    75Ml</a></h4>
                <p class="shop_pera">SKIN1004</p>
                <del>300,000đ</del> <ins>259,000đ</ins>
                <h5>
                  Giới Thiệu
                  Kem Dưỡng Ẩm Skin1004 Làm Dịu Da Chiết Xuất Rau Má 75ml là kem dưỡng đến từ thương hiệu mỹ phẩm
                  Skin1004 của Hàn Quốc, thành phần chứa 72% chiết xuất rau má cùng với 4 loại Ceramide có nguồn gốc từ
                  thực vật làm dịu làn da mụn, kích ứng, giúp tăng cường hàng rào bảo vệ da, nuôi dưỡng làn da khỏe
                  mạnh.
                </h5>
              </div>
            </div>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                  <div class="cc_ps_deliv_main_wrapper">
                    ...
                    <div class="cc_ps_bottom_cont_list_wrapper">
                      <ul>
                        <li>- Giao hàng nhanh (trong vòng 24h)</li>
                        <li>
                          - Trả hàng (trả hàng trong vòng 15 ngày nếu sản phẩm không đúng như mô tả)
                        </li>
                      </ul>
                    </div>
                  </div>
                    ...
                    <ul>
                      <li>
                        <div class="ss_toprated_slider_box_img">
                          <a href="#">
                            <img src="https://www.guardian.com.vn/media/catalog/product/cache/8abedaa231e51c424533dabd39634738/t/h/thumbnail_3024648_9ekrjpcichziepuj.jpg" alt="Product" />
                          </a>
                        </div>
                        <div class="ss_toprated_slider_box_text">
                          <h4><a href="#">Kem Chống Nắng Cho Da Nhạy Cảm Skin1004 Madagascar Centella Air-Fit Suncream Plus Spf50+ Pa++++ 50Ml</a></h4>
                          <ins>300,000đ</ins> <del>229,000đ</del>
                        </div>
                      </li>
                      <li>
                        <div class="ss_toprated_slider_box_img">
